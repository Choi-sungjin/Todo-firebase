...
| 파일 | 변경 유형 | 요약 |
|------|-----------|------|
| `index.html` | favicon | 상대 경로 `./favicon.png?v=2` 적용, 캐시 무효화로 배포 시 아이콘 갱신 |
| `HANDOFF.md` | 문서 수정 | favicon 경로·캐시 무효화 안내 추가 (2-1, 2-2) |
...
*마지막 업데이트: 2026-03-01, Cursor 턴 – favicon 캐시 무효화(?v=2), 상대 경로 적용, HANDOFF에 favicon 안내 추가*
